...
valid_users = {
    ...
    "YAEL": "Yael",
    "R2RGRAL": "TL R2R GRAL",
    "MSANCHEZ": "Miriam Sanchez",  # Ahora se asigna a R2R GRAL
    # WOR SGBS:
    "MLOPEZ": "Miguel Lopez",
...
# ================================
# Función para obtener el equipo de un TL según su grupo
# ================================
...
def show_main_app():
    ...
    if menu_choice == "Asistencia":
        # Para usuarios normales, se muestra el formulario de registro de asistencia.
        if user_code not in TL_USERS:
            ...
            # Para TL: solo se muestra el resumen en formato gráfico de la asistencia de su equipo
            ...
            if data_list:
                ...
                st.bar_chart(df_energy.set_index("Usuario"))
            else:
    ...
    # ------------------- Top 3, Action Board, Escalation, Recognition, etc. -------------------
    # (Las demás secciones se mantienen iguales que en versiones anteriores)
    # Para abreviar, aquí se incluyen sin modificaciones adicionales.
